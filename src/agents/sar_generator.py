...
class SARGenerator:
    ...
    def _synthesize_narrative(self, log: Dict[str, Any]) -> str:
        """
    ...
    def generate_report(self, state: Dict[str, Any]) -> str:
        ...
        # Expert Weights
        weights = {
            "ATO": 0.2, "AML": 0.25, "SyntheticID": 0.25,
            "CNP": 0.1, "APP": 0.1, "Velocity": 0.1
        }
        ...
        # Normalize score based on agents actually consulted
        final_risk = (total_score / total_weight_used) if total_weight_used > 0 else 0
